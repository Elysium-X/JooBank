   ...
   (
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
     ...
     <div className='flex-[1.5] w-full flex flex-row justify-between flex-wrap mt-10 md:mt-0'>
          ...
          <ul className='list-none mt-4'>
            ...
            {footerLink.links.map((link, index) => (
              <li key={link.name} className={`font-poppins font-normal text-[16px] leading-[24px] text-dimWhite
               hover:text-secondary cursor-pointer mb-4 last:mb-0`}>
      ...
      <div className='flex  w-full justify-between items-center md:flex-row flex-col pt-6 border-t-[2px] border-t-[#18f1f5ba]  rounded-[4px]'>
        <p className='font-poppins font-normal text-center text-[18px] leading-[27px] text-white'>
          2025 Joobank. All Rights Reserved.
        </p>
